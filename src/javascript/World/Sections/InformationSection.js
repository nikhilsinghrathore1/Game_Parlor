...
export default class InformationSection
{
    ...
    setBaguettes()
    {
        ...
        this.baguettes.a = this.objects.add({
            ...
            duplicated: true,
            shadow: { sizeX: 0., sizeY: 0, offsetZ: - 0.,alpha: 0},
            mass: 1.5,
            // soundName: 'woodHit'
        })
    ...
    setLinks()
    {
        ...
        this.links.options = [
            {
                href: 'https://twitter.com/NikoChan256',
                labelTexture: this.resources.items.informationContactTwitterLabelTexture
            },
            {
                href: 'https://github.com/nikhilsinghrathore1/',
            ...
            {
                href: 'mailto:sunny3355sing@gmail.com',
