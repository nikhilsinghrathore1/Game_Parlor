        ...
        this.list = [
            {
                ...
                imageSources:
                [
                    './models/projects/threejsJourney/doom4.png',
                    './models/projects/threejsJourney/doom2.png',
                    './models/projects/threejsJourney/doom3.png',
                    './models/projects/threejsJourney/doom_1.png'
                ],
                floorTexture: this.resources.items.projectsThreejsJourneyFloorTexture,
                link:
                {
                    href: 'https://boomar.vercel.app',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                imageSources:
                [
                    './models/projects/chartogne/slide1.png',
                    './models/projects/chartogne/slide2.png',
                    './models/projects/chartogne/slide3.png'
                ],
                floorTexture: this.resources.items.projectsChartogneFloorTexture,
                link:
                {
                    href: 'https://ao-karts.vercel.app',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
